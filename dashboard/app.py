...
def display_model_accuracy(accuracy_df, symbol):
    ...
    if accuracy_df.empty and not os.path.exists(confusion_matrix_path):
        st.warning("⚠️ No accuracy metrics available. Run the Random Forest model first.")
        return
    ...
    if os.path.exists(confusion_matrix_path):
        ...
        st.warning("⚠️ Confusion matrix not available for this stock.")
    ...
    if os.path.exists(feature_importance_path):
        ...
        st.warning("⚠️ Feature importance not available for this stock.")
